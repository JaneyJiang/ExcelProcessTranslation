...
namespace SortTool
{
    static class CommonTools
    {
        ...
        static public Dictionary<string,string> DataTableToDict(DataTable dt, int src=0, int tgt=1)
        {
            ...
            return dt.Rows.Cast<DataRow>().ToLookup(x => x[src].ToString(), x => x[tgt].ToString())
